...
BUCKET_NAME = 'wagon-data-664-gaillot-anime_map'
...
BUCKET_TRAIN_DATA_PATH = 'data/active_users_df_10PlusRatings_PG.csv'
...
MODEL_NAME = 'anime_map_NeuMF_Perceptron'
