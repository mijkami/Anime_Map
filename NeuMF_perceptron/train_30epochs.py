...
def get_data():
    ...
    df = pd.read_csv("data/processed_data/active_users_df.csv")
...
STORAGE_LOCATION = 'models/anime_map/NeuMF_MLperceptron_full_data_30epochs'
...
def save_model(model):
    ...
    tf.keras.models.save_model(model,
                               'NeuMF_MLperceptron_full_data_30epochs.h5')
    print("saved model NOT joblib locally")
    upload_model_to_gcp()
    print(
        f"uploaded NeuMF_MLperceptron_full_data_30epochs.h5 to gcp cloud storage under \n => {STORAGE_LOCATION}"
    )
...
def upload_model_to_gcp():
    ...
    blob.upload_from_filename('NeuMF_MLperceptron_full_data_30epochs.h5')
